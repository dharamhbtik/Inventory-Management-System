        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InventoryId = table.Column<int>(type: "int", nullable: false),
                    QuanittyBefore = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 1000.0, "Gas Car", 1 },
                    { 2, true, 400.0, "Electric Car", 1 },
                    { 3, true, 100.0, "Petrol Car", 1 },
                    { 4, true, 50.0, "Diesel Car", 5 }
                });
