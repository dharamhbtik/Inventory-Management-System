...
namespace IMS.Plugins.EFCore
{
    ...
    {
        public IMSContext(DbContextOptions dbContextOptions) : base(dbContextOptions)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { ProductId = 3, ProductName = "Petrol Car", Price = 100, Quantity = 1, },
                new Product { ProductId = 4, ProductName = "Diesel Car", Price = 50, Quantity = 5, }
                );
